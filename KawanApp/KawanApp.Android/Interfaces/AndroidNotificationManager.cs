...
namespace KawanApp.Droid.Interfaces
{
    public class AndroidNotificationManager : INotificationManager
    {
        ...
        const string channelDescriptionMessage = "The channel for chat messages.";
        const string channelDescriptionFriends = "The channel for friend requests getting received and accepted.";
